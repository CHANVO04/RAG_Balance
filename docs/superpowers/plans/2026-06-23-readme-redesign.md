# Cấu trúc lại README.md của RAG Balance

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Cấu trúc lại file README.md của RAG Balance theo phong cách chuyên nghiệp giống NexusRAG nhưng giữ giọng văn tiếng Việt đơn giản, dễ hiểu và phản ánh chính xác codebase hiện tại.

**Architecture:** Cập nhật file README.md ở thư mục gốc để tích hợp ảnh sơ đồ kiến trúc hệ thống đã tạo, bảng so sánh tính năng RAG, các phần tính năng ẩn hiện chi tiết, luồng hoạt động Mermaid, hướng dẫn chạy chi tiết và bảng Tech Stack chia theo nhóm (Backend, Frontend, Infrastructure).

**Tech Stack:** Markdown, Mermaid.

---

### Task 1: Xác minh tài nguyên ảnh sơ đồ kiến trúc
**Files:**
- Test: `docs/assets/architecture.png`
- Test: `docs/assets/image.png`

- [ ] **Step 1: Kiểm tra tệp tin ảnh trong thư mục assets**
  Run: `dir docs/assets/`
  Expected: Cả hai tệp `architecture.png` và `image.png` đều tồn tại trong thư mục.

- [ ] **Step 2: Commit xác nhận tài nguyên**
  Run: `git status`
  Expected: Trạng thái sạch hoặc chỉ có các file spec/plan mới.

---

### Task 2: Cập nhật nội dung README.md
**Files:**
- Modify: `README.md`

- [ ] **Step 1: Viết đè toàn bộ nội dung README.md mới**
  Hãy ghi đè toàn bộ nội dung của tệp `README.md` bằng đoạn văn bản sau:
...
[Tính năng](#tính-năng-nổi-bật) · [So sánh](#điểm-vượt-trội-so-với-rag-truyền-thống) · [Kiến trúc](#kiến-trúc-hệ-thống) · [Khởi chạy nhanh](#hướng-dẫn-chạy-nhanh) · [Công nghệ sử dụng](#các-công-nghệ-khoa-học-chính-được-sử-dụng)
...
* **Dung lượng ổ cứng**: Còn trống tối thiểu 10GB (để tải ảnh Docker cho Qdrant, Neo4j và tải thư viện PyTorch nặng khoảng 2GB).
...
- [ ] **Step 2: Lưu và thoát**
  Xác thực toàn bộ nội dung đã khớp chính xác và lưu tệp tin.

---

### Task 3: Xác minh cú pháp Markdown và liên kết
**Files:**
- Test: `README.md`

- [ ] **Step 1: Kiểm tra lỗi cú pháp Markdown**
  Xác nhận các thẻ đóng mở `<details>` và `</details>` được đặt chính xác, không làm vỡ các đề mục lớn.

- [ ] **Step 2: Kiểm tra liên kết hình ảnh**
  Xác minh tệp `docs/assets/architecture.png` được nhúng đúng cú pháp `![Sơ đồ kiến trúc RAG Balance](docs/assets/architecture.png)`.
